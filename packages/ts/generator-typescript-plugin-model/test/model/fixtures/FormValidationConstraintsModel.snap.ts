import {
  ...
  AssertFalse as AssertFalse_1,
  AssertTrue as AssertTrue_1,
  DecimalMax as DecimalMax_1,
  DecimalMin as DecimalMin_1,
  Digits as Digits_1,
  Email as Email_1,
  Future as Future_1,
  Max as Max_1,
  Min as Min_1,
  Negative as Negative_1,
  NegativeOrZero as NegativeOrZero_1,
  NotBlank as NotBlank_1,
  NotEmpty as NotEmpty_1,
  NotNull as NotNull_1,
  Null as Null_1,
  NumberModel as NumberModel_1,
  ObjectModel as ObjectModel_1,
  Past as Past_1,
  Pattern as Pattern_1,
  Positive as Positive_1,
...
class FormValidationConstraintsModel<
  T extends FormValidationConstraints_1 = FormValidationConstraints_1,
> extends ObjectModel_1<T> {
  ...
  get list(): ArrayModel_1<string, StringModel_1> {
    return this[_getPropertyModel_1]('list', ArrayModel_1, [
      ...
      [true],
      new NotEmpty_1(),
    ]) as ArrayModel_1<string, StringModel_1>;
  }
  ...
  get notEmpty(): StringModel_1 {
    return this[_getPropertyModel_1]('notEmpty', StringModel_1, [
      true,
      new NotEmpty_1(),
      new NotNull_1(),
    ]) as StringModel_1;
  ...
  get min(): NumberModel_1 {
    return this[_getPropertyModel_1]('min', NumberModel_1, [
      true,
      new Min_1({ value: 1, message: 'foo' }),
    ]) as NumberModel_1;
  }
  ...
  get decimalMax(): NumberModel_1 {
    return this[_getPropertyModel_1]('decimalMax', NumberModel_1, [
      false,
      new DecimalMax_1({ value: '0.01', inclusive: false }),
    ]) as NumberModel_1;
  }
  ...
  get digits(): StringModel_1 {
    return this[_getPropertyModel_1]('digits', StringModel_1, [
      true,
      new Digits_1({ integer: 5, fraction: 2 }),
    ]) as StringModel_1;
  }
