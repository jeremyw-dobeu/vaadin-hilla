...
class FormEntityModel<T extends FormEntity_1 = FormEntity_1> extends FormEntityIdModel_1<T> {
  ...
  get entityHierarchy(): FormEntityHierarchyModel_1 {
    return this[_getPropertyModel_1]('entityHierarchy', FormEntityHierarchyModel_1, [
      true,
    ]) as FormEntityHierarchyModel_1;
  }
  ...
  get validationConstraints(): FormValidationConstraintsModel_1 {
    return this[_getPropertyModel_1]('validationConstraints', FormValidationConstraintsModel_1, [
      true,
    ]) as FormValidationConstraintsModel_1;
  }
