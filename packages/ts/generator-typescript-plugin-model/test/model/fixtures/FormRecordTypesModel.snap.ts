...
class FormRecordTypesModel<T extends FormRecordTypes_1 = FormRecordTypes_1> extends ObjectModel_1<T> {
  ...
  get entityHierarchyMap(): ObjectModel_1<Record<string, FormEntityHierarchy_1>> {
    return this[_getPropertyModel_1]('entityHierarchyMap', ObjectModel_1, [true]) as ObjectModel_1<
      Record<string, FormEntityHierarchy_1>
    >;
  }
  get stringListMap(): ObjectModel_1<Record<string, ReadonlyArray<string>>> {
    return this[_getPropertyModel_1]('stringListMap', ObjectModel_1, [true]) as ObjectModel_1<
      Record<string, ReadonlyArray<string>>
    >;
  }
  get selfReferenceMap(): ObjectModel_1<Record<string, FormRecordTypes_1>> {
    return this[_getPropertyModel_1]('selfReferenceMap', ObjectModel_1, [true]) as ObjectModel_1<
      Record<string, FormRecordTypes_1>
    >;
  }
  get complexMap(): ObjectModel_1<Record<string, Record<string, ReadonlyArray<FormOptionalTypes_1>>>> {
    return this[_getPropertyModel_1]('complexMap', ObjectModel_1, [true]) as ObjectModel_1<
      Record<string, Record<string, ReadonlyArray<FormOptionalTypes_1>>>
    >;
  }
